...
W.addLink("link2", "orig2", "merge", length=1000, free_flow_speed=30, number_of_lanes=3)
W.addLink("link3", "merge", "dest", length=1000, free_flow_speed=30, number_of_lanes=3)
## ノード間のOD交通需要の作成
